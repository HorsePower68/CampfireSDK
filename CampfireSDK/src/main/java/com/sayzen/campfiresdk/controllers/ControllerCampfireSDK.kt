...
object ControllerCampfireSDK {
    ...
    var ON_TO_CHAT_CLICKED: (chatType: Long, targetId: Long, targetSubId: Long, action: NavigationAction) -> Unit = { chatType, targetId, targetSubId, action -> }
    ...
    fun onToChatClicked(chatType: Long, targetId: Long, targetSubId: Long, action: NavigationAction) {
        ON_TO_CHAT_CLICKED.invoke(chatType, targetId, targetSubId, action)
    }
