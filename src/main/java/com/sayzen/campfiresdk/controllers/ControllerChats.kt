    ...
    fun getSystemText(publication: PublicationChatMessage): String {
        ...
        when {
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_BLOCK -> return if (publication.blockDate > 0) {
                "${ToolsResources.s(R.string.chat_block_message, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_blocked, R.string.she_blocked), ControllerLinks.linkToUser(publication.systemTargetName))} " + "\n ${ToolsResources.s(R.string.app_comment)}: ${publication.systemComment}"
            } else {
                "${ToolsResources.s(R.string.chat_system_block, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_warn, R.string.she_warn), ControllerLinks.linkToUser(publication.systemTargetName))} " + "\n ${ToolsResources.s(R.string.app_comment)}: ${publication.systemComment}"
            }
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_ADD_USER -> return "${ToolsResources.s(R.string.chat_system_add, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_add, R.string.she_add), ControllerLinks.linkToUser(publication.systemTargetName))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_CREATE -> return "${ToolsResources.s(R.string.chat_system_create, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_created, R.string.she_created))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_REMOVE_USER -> return "${ToolsResources.s(R.string.chat_system_remove, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_remove, R.string.she_remove), ControllerLinks.linkToUser(publication.systemTargetName))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_CHANGE_IMAGE -> return "${ToolsResources.s(R.string.chat_system_change_image, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_changed, R.string.she_changed), publication.systemTargetName)}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_CHANGE_NAME -> return "${ToolsResources.s(R.string.chat_system_change_name, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_changed, R.string.she_changed), publication.systemTargetName)}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_LEAVE -> return "${ToolsResources.s(R.string.chat_system_leave, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_leave, R.string.she_leave))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_ENTER -> return "${ToolsResources.s(R.string.chat_system_enter, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_reenter, R.string.she_reenter))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_PARAMS -> return "${ToolsResources.s(R.string.chat_system_params, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_changed, R.string.he_changed))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_LEVEL -> return "${ToolsResources.s(R.string.chat_system_level, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_changed, R.string.he_changed), ControllerLinks.linkToUser(publication.systemTargetName), ToolsResources.s(if (publication.systemTag == API.CHAT_MEMBER_LVL_USER) R.string.app_user else if (publication.systemTag == API.CHAT_MEMBER_LVL_MODERATOR) R.string.app_moderator else R.string.app_admin))}"
            publication.systemType == PublicationChatMessage.SYSTEM_TYPE_CHANGE_BACKGROUND -> return "${ToolsResources.s(R.string.chat_system_background, ControllerLinks.linkToUser(publication.systemOwnerName), ToolsResources.sex(publication.systemOwnerSex, R.string.he_changed, R.string.he_changed))}"
            else -> return ""
        }
