...
/*
    ...
    Убрть возможность бесконечно смотреть видео
    ...
    Баг. После установки приложения заноко все настраивал и слетел Hello.

    Ежедневка поучаствовать в активности
    Подробная инфа в блок
    Би. Папки в закладках

    Би. Автофильтр мата
        -   Нужен скоросной парсинг текста. Использовать его же для парсинга ссылок.
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Контроллер работы сервера
    Редизайн голосового сообщения
    Добавить кнопку поменять фон фэндома
    Новый бокс со снегом
    Возможность прервать экран загрузки

    Баг. Не работает преход по уедомлению эстафеты
    Баг. Опечатка "и чтобы повысить"
    Баг. Бомба сначала рисуется в углу
    Баг. После обновления черного списка фндомов все пропадает
    Баг. Масимум 9 просмотров
    Баг. Не показывается что наместник админ
    Баг. Неправильный текст коммента на который ответил (снова)
    Баг. у голосоваого сообщения в блоке нет отступов
    Баг. В цитате не форматирована ссылка на фэндом
    Баг. Баг с беком в диалоге комментария
    Баг. Если расширить пост и проматать ленту, то нажатие на бек, схлопнит этот пост
    Баг. Пустой список картинок елетает
    Баг. Нет кнопки скрыть после расширения
    Баг. При сворачивании/разворачивании поста инстансится новое View
    Баг. Мерцают картинки при раскрытии поста (Убрать анимацию при загрузке из RAM)
