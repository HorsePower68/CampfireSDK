...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    - Теперь админы начиная с 7го уровня имеют доступ в админскую.
    - Теперь можно меня фон в конференциях и дополнительных чатах фэндома.
    ...
    - Campfire Hello теперь привязан к языку, это значит что за один час может быть несколько постов на разных языках, а не один.

    Исправления:
    - У некоторых пользователей не работали голосования.
    - Было нелья выполнить квест на создание чата фэндома.
    - На некоторых комментариях неправильно засчитывался оофицент фэндома.
    - Был виджет оценки при просмотре оценок своего поста.
    - Найдено 100 рублей в зимней куртке.
    - Опечатка: Мнимальный
    - Опечатка: Спсика
    - При демо просмотере стартового экрана, не было экрана с вобором пола.
