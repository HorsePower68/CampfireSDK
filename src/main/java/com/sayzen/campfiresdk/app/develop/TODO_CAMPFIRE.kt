...
/*
    ...
    Баг. Невозможно поставить голосовуху на паузу
    Баг. Если быстро щелкать по голосувухам одна будет играть без анимации
    
    Спойлер в форматирование текста
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Новая система - наместники. В каждом фэндоме, отдельно для каждого языка может быть назначен наместник. Это человек будет заниматься развитием фэндома, эго описание, контентом и популиризацией. Зачем? Ради 8-ми новых достижений, созданных специально для наместников. Наместником вам может сделать только админ.
    ...
    - Добавлена коробка с вылетом из приложения.
    - Добавлена коробка с бомбой.
    - Немного доработанны ссылки, может чтонибудь сломаться...
