...
/*
    ...
    Программная потдержка рубрик
        -  ? Возможность редактировать модератору (комментарий и событие) - Уведомление что рубрика изменена
        -  ? Возможность удалить модератору (комментарий и событие) (СТАТУС!) -   Уведомление что рубрика удалена
        -  ? Возможность передать рубрику модератору (комментарий и событие) - Уведомление что назначна рубрика - Уведомление что рубрика назначена на другого
        -  ? Доступ к управлению через экран постов рубрики
        -  Реакция на события

        -   Повышение(0.05 коофа кармы (макс 3)
        -   Понижение коофа кармы(0.10)
        -   ?Как это будет работать с множетелем фэндома
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    - Админ мог удалять свои наказания. (Привет арчи)
