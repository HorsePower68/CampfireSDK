...
/*
    ...
    ! Подробная инфа о пропавших комментах (диалог)
    ! Подробная инфа о пропавших сообщениях (диалог)
    ! Подробная инфа о пропавших стикерпаках



    Баг. После отказа от эстафеты не сбрасывается счетчик
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Подробная инфа о пропавших постах + переход к модерации
    ...
    Баг. Иконка свайпа
    Баг. Можно закрыть создание коммента беком
    Баг. Не работает ссылка на чт Noob
    Баг. Нет форматирования ссылок в цитатах
    Баг. Не работает форматирование ссылок кемпа
    Баг. Иконка у чата
