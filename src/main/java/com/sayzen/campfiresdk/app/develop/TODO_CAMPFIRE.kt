...
/*
    ...
    Вырезать рекламу
    Баг. Проблема с онлайном происходит из-за того что выходит время онлайна
    Баг. Можо несколько раз нажать на кнопку при добавлении страницы
    Баг. ?В поле ввода ссумы можно ввести буквы
    Баг. Приходит уведомление о своем мод. действии если жаловался
    Баг. Не работает изменение сообщения
    Баг. Опечатка потдержку

    Сделать таблицу лидеров доната
    Проверять доступность сервера дважды, по три попытки
    Убедиться что новички подписываются на чаты

    Пополнить мат фильтр (ахуеваю, охуеваю, поебать)
    Убрать из мат фильтра (жопа, насрать)
