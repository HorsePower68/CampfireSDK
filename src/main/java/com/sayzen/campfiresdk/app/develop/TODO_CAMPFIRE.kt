...
/*
    ...
    Баг. При нажатии обрезать в картинке коммента диалог не пропадает
    Баг. Нельзя пройти выбор ника если акк забанен
    Баг. После просмотра видео пропадает навигация
    Баг. Если открыт ютюб и вернуться в риложение - бесконечная загрузка
    Баг. Повторно открывается тот-же чат
    Баг. Хелмаус не модератор в mice
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    - Добавлена галочка не показывать подписки в бездне в фильтры ленты.
