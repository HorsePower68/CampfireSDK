...
/*
    ...
    Конфирренции
        - ! Последнее сообщение что удалили, но пользователь видит другое
        -   Удаленный пользователь может нажать кнопку редактирвоать чат
        -   Возможность покинуть (нельзя больше добавить, но можно удалить)
        -   Возможность вернуться
        -   Что если пользователь исключит создателя? (посмотреть у вк)
        -   Отображать что пользователь покинул чат в редактировании
        -   Если удалить чат из истории к нему будет невозможно вернуться. Запретить это дулать. (Сделать как в вк)





    Похоже в ФБ нужно добавить параметры
    Баг. Админ в предложении фэндома отображается как юзер
    Баг. Неправильный экрна после удаления фэндома
    Баг. Не выделен пользователь в обычном сообщении с ответом
    Баг. Нельзя делать админа модером
    Баг. Нет майна в глобальном поиске фэндомов
    ...
    Баг. У пользователей ломается интерфейс после поялвения клавиатуры
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Поменять дату дня рождения
    Запоминать согласие с закрытыми фэндомамми
    Аналитика
    Закрытые посты
    ...
    Баг. Не обновляется дата прочтения если от пользователя пришло ЛС или то тчо он печатает
    Баг. Нет перехода к публикации по даминским действиям
    Баг. Первое сообщение в лс сразу прочитано
    Баг. При ошибке перехода к чату, ничего не происходит
