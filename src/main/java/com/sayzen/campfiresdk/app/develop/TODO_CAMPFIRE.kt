...
/*
    ...
    Баг. Навигация накрывает экран выбора пола
    Переработь экран с выбором категорий (4 категории)
    !Ускорить анимаацию
    !Отразить охотницу
    !Увеличить картинки в поле
    !Изменения не должны применятсья с демо
