...
/*
    ...
    История поста
    -  !!! Закреплен НЕТ в фэндоме
    -  ? Закреплен в профиле
    -  ? Закреплен НЕТ в профиле

    История коммента
    -   Изменение + старый вариант
    История сообщения
    -   Изменение + старый вариант
    ...
    Баг. Админ при изменении тегов статьи видит галочки

    Не скрывать кнопки при скролле списка фэндомов
    Возможность протоадмину вернуть из глубокой блокировке (+история)
