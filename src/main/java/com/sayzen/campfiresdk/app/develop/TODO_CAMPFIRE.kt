...
/*
    ...
    Комментарии при донате
        -   ПОХОЖЕ РУЧНАЯ ВСТАВКА ДАЕТ НАПРАВИЛЬНУЮ СУММУ!
        -   Учитывать комментарий при донате через телфон
    ...
    Баг. Не грузит ресурс @post_521371_522843
    ...
    Баг. При изменении описания фэндома не видно поля комента. Вынести отдельным виджетом
    Баг. В уведомлениях о эстафете сломаны ссылки
