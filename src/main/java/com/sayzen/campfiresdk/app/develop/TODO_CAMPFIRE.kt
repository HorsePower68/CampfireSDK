...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Campfire 0.83 Beta
    Обратная совсместимость (заработает когда выйдет следующее обновление)! Теперь приложение будет работать даже если оно устарело, но есть вероятность нестабильной работы. В ленте будет отображаться огромное сообщение с просьюой обновиться. В битве идей победила вики и свои темы. Свои темы сделать технически не возможно. НО, я добавил кучу разных готовых тем (по сути разный цвет баров). Традиционно белые темы находятся в глубокой альфе и я их дорабатываю. Вики - она еще не завершена и надеюсь будет готова к следующему обновлению, работа над ней кипит, не переживайте. :)
