...
/*
       ...
       - Возможность запретить юзерам приглашать

       - Возможность назначать модераторов беседы
       - Подписывать кто создатель/модератор/пользователь в беседе
       - Модераторы могут исключать пользователей
       - Модераторы не могут исключать модераторов
       - Управлять параметрами может только админ
...
----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        Исправление ошибок
        Очередное, традиционное исправление ошибок прошлого обновления. Их не могло не появиться, обновление очень силньо переработало чаты. :)
