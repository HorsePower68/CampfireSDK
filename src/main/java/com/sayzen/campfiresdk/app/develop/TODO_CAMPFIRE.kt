...
/*
    ...
    Программная потдержка рубрик
        -   Создание рубрики (комментарий и событие)
        -   Возможность удалить модератору (комментарий и событие) (СТАТУС!)
        -   Возможность редактировать модератору (комментарий и событие)
        -   Возможность передать рубрику модератору (комментарий и событие)
        -   Возможность передать рубрику

        -   Повышение(0.05 коофа кармы (макс 3)
        -   Понижение коофа кармы(0.10)

        -   Уведомление что назначна рубрика
        -   Уведомление что рубрика назначена на другого
        -   Уведомление что рубрика изменена
        -   Уведомление что рубрика удалена
