...
/*
    ...
    !Цвет коммента в статье и профиле
    Настройка ленты
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Несколько слов о темах приложения. Прощальных слов. Я хочу создать собственный стиль Campfire, чтобы приложение легко узнавалось и имело свой характер. Да, это было весело, мы могли настраивать разные цвета для кемпа, кому какой нравится. Но это очень сложно потдерживать, особенно белую тему. Кемпафаер постепенно меняет свой дизайн и постепенно мы придем к минимальному количеству визуального мусора на экране. Для того чтобы реализовать эти планы, было решено отказаться от возможности менять тему и сосредоточется на создании одной, но максимально качественно темы. Кемпафаер стал практически полностью черным, я знаю что многим это не понравится и я готов менять тему так, чтобы она была максимально приятной для всех. Это первый шаг на пути к созданию лучшей темы, жду отзывов для дальнейшего развития.
