...
/*
    ...
    !Не корректно считается достижение с кол-вом постов в моей эстафете
    ...
    $ Наместники
        -   Возможность назначить (+ событие админа) (+ событие юзера) (+ уведомление)
        -   Возможность снять (+ событие) (+ событие юзера) (+ уведомление)
        -   Отображать в верху фэндома
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Campfire 0.94 Beta
    В битве идей решили что нужны достижения для эстафет - получайте.
