...
/*
    ...
    Конфирренции
        -   В пустом поиске отображать подписки
        -   Возможность отключить уведомления
        -   Редактирование (+событие)
        -   Добавление пользователей (+событие)
        -   Удаление пользователей (+событие)
        -   Подтверждение выхода с экрана создания
        -   Возмодность покинуть (нельзя больше добавить, но можно удалить)
        -   Возмодность вернуться
        -   Миграция. Удалить все события модерации из чатов
        -   Защита от сторонней подписки
        -   Показывать кол-во участников
        -   Избавиться от  tag_2 - targetId tag_3 - targetSubId у сообщений
    ...
    !!! Сделать чтоб новая задача заводилась на автора
