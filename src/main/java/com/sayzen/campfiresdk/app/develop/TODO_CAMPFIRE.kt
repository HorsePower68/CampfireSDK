...
/*
    ...
    Программная потдержка рубрик
        -   Рубрика выбирается при создании поста
        -   Экран рубрик (список и переход к списку постов)
        ...
        -   Возможность модератору поменять владельца

        -   ?Как это будет работать с ножетелем фэндома
