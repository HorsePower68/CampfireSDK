...
/*
    ...
    Фразы:
        ...
        Пригласи друга, получи печеньку!
        У нас мало времени!
        Не кормите обезьян!
        В случае пожара разбить и бежать!
        Не подходит для детей старше 21.
        Здесь могла быть ваша фраза, просто напишите мне.
        Поприветствуйте новичков в Campfire Hello.
        Не заступайте за край земли.
    ...
    Избавится от дерганных анимаций
    Возможность анонимно оценить с экрана оценок
    Настройка выбор стикеров через паки
    Возможность ограничить голосование по уровню
    Корзина для постов и черновиков
    При открытии поста с упоминаем, уведомление не читается
