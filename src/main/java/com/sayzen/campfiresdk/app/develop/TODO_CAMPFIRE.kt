...
/*
        ...
        !Лишний отступ у даты
        Баг. В диалоге выбора даты нельзя скролить год

        - Вылетает сервер если добавлять пользователй при создании

        Возможность ставить эмоции на комменты (?и сообщения)
            -   Выбор из пресетов (ненмого, один экран)
            -   Отображения эмоции и кол-ва
...
----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        Возможность запретить юзерам приглашать в беседу
        Объединять сообщения в группы как в вк.
        Возможность назначать модераторов беседы
        Добавить 1dp отступа для списка картинок сверху и снизу
        Фон экрана потери соединения
        ...
        Баг. В лс иногда 9+ сообщений
        Баг. Не переходит к посту и комменту по уведолнию о карме
        Баг. В диалоге отчистки истгории чата написано убрать
        Баг. Чат при удалении просто падает вних списка
        Ьаг. После любого изменения чата мерцает аватар
