...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Campfire 0.96 Beta
    Продолжаю избавлять Campfire от визуального мусора, на этот раз под нож попали иконки с флагами. Идеи из последней битвы будут реализованы немного позже (поиск постов пользователя в фэндоме и коммнтарии к жалобам).
