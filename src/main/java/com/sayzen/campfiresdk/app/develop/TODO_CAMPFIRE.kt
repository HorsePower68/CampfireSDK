...
/*
    Баг. В прфоиле пользователя написано что он востановил публикацтю
    !!! Не работает лента по подпискам после перезахода
    !!! Сломается завершение квеста по уведомлению!
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Сделать админские события доступными всем
    ...
    Отображать в профиле пользователя какое ежедневное задание он выполнил
    ...
    Баг. можно изменить коофицент на тот-же самый
    Баг. нет проверки корректности данных сразу при появлении диалога
    Баг. Нет перехода к фэндому через уведомление о отмене мод. действия
    Баг. Нет перехода к мод действию через уведомление о отмене мод. действия
