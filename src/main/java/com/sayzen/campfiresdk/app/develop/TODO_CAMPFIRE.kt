...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    - В уведомлениях о комменатриях и постах теперь будет пояснение, какой именно пост/коммент имеется ввиду.
    - При открытии окна создания голосования, фокус будет автоматически ставиться на первое поле.
    - Для эстафет добавлен экран с более подробнйо информацией.

    Исправления:
    - Эстафета не передавалась по таймеру.
    ...
    - Нельзя было давать имена ссылка Campfire.  ([Клик]Ссылка)
