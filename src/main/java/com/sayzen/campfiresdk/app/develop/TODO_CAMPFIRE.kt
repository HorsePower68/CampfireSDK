...
/*
    ...
    $ Наместники
        -   Возможность назначить (+ событие админа) (+ событие юзера)(+ событие фэндома?) (+ уведомление) (Уведомление что назначен другой)
        -   Возможность снять (+ событие) (+ событие юзера)(+ событие фэндома?) (+ уведомление)
        -   Текст если нет наместника
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Campfire 0.94 Beta
    В битве идей решили что нужны достижения для эстафет - получайте. В целом доработал эстафеты, добавил нескоько полезных функцый. Вернулась видео реклама.
    ...
    После выбора доа функций отображать их на основном экране
    Убрать разделители у ачивок
    Поработать над экраном привилегий
    Возможность подписаться на эстафету (Получать уведомления о новых постах) (Автоматически подписывать участников)
    ...
    Баг. После смены аккаунта не сбрасывается счетчик сообщений
    Баг. Если зайти в вики через английский фэндом посты все равно на русском
    Баг. Нет перехода к сообщению в чате по уведомлению о ответе.
    Баг. Нет выхода с экрана эстафеты при удалении
    Баг. Виджет выбора картинки сначала отображается очень маленьким
