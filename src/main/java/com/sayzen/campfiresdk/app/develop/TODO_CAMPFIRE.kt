...
/*
    ...
    !!! Аватар по прежнему обрезает
    !!! Ачивка за виде за месяц

    $ Эстафеты
        -   ОБРАБОТКА ОШИБОК ПРИ ОТКАЗЕ
        ...
        -   Возмодность верняться в эстафету если отказался
        -   Запретить передавать тем кто отказался или участвоавал
        ...
        -   Отображать чип в навигации
        -   Отображать чип на настроке

        -   Что если пользователь удалт пост или его заблокируют
        -   Что если пользователь вернет пост в черновики
        -   Что если эстафету адлят а посты будут?


    Баг. При возврате с экрана выбора пользователя внизу нет навигации
    В стандартной ленте написано Все, должно быть Лента
    Часто не работает переход в чат по уведомлению
    Баг. Не сбрасывается интент. (Нажать уведомление о комменте -> перейти -> открыть ютюб )
    !После смены аккаунта сервый фон
    -   !Квест с лентой не понятен
    В цветной теме должны быть белые иконки навигации
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Основное нововедение этой версии - активности. Этот экран по задумке будет содержать в себе различные действия которые моет выполнить пользователь. Например админы смогут там просматривать жалобы на посты и пользователей. Первая пользоательская активность которая уже реализована - эстафеты.
