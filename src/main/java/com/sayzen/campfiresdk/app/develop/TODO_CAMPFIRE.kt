...
/*
    ...
    Пользователям не очевидно почему нет эстафет при создани поста
    Баг. При нажатии на уведомление о сообщени в чате, котрый уже открыт, нет скролла
    Баг. В ммент ввода логина если нажать Enter то поле заполнится фигнеё
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Кастомный диалог
    Линия на экране АКТИВНОСТЕЙ если нет протоадминской
    Цвет чипа на эстафете
    Не показывать чип если 0
    Вынести рубрики в активности
    Увеличить запас у карточки поста, а то на показ больше 10 пикселей увеличивает
    В посте не понятно что это эстафета


    - Отображался плюс при выборе категории для поста.
    Баг. Вылеты при отображении диалога загрузки
    Баг. Часто лшнйи раз отображается кнопка показать
