...
/*
    ...
    $ Би. (не напрямую) Сделать возможность в профиле посмотерть посты из конкретного фэндома
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    $ Би. Убрать запрет на модерацию тех у кого больше кармы
    По умолчанию вводить сумму пожертвования 10 рублей
    Писать в профиле что спонсор
    Донаты списком транзакций
    После нажатия на пожертвовать, писать спасибо
    Объединить таблицы саппорт и донаты
    Комментарии при донате
    В новогоднии дни в кемпе по умолчанию должен идти снег
    В новогоднии дни заменять аватарки пьзователей
    В новогоднии дни в профиле должна быть герлянда
    Не перезапускать одну и туже анимацию
    При изменении описания фэндома не видно поля комента. Вынести отдельным виджетом
