...
/*
    ...
    !!! Иногда появляется навигациия при откратии диалогов
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    - Цитаты тепреь максимум 300 символов.
    ...
    История публикаций
    Не скрывать кнопки при скролле списка фэндомов
    Возможность нажать на название фэндома
    Возможность протоадмину вернуть из глубокой блокировке
    ...
    Баг. Если не подписан то не видно фэндомов
    Баг. После того как сделал мультиязычным нельзя сразу сделать не мультиязычным
    Баг. В чате иногда дублируются сообщения
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Оптимизация, лента подтупливает при скролле
