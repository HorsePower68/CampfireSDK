...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Изменения:
    Убрать в диалогах имя того кто нписал
    Заменить своё имя в диалогах на Вы
    Убрать полоски в сообщениях и уведомлениях
    Переносить скрепку
    Пометил пост как важный
    Зимняя коробка слишком лютая
    Кнопка "Готово" при выборе доп опцый для поста
    Оптимизировать работу с сдк
    ...
    Баг. Из-за виджета загрузки в чате появляются дыры
    Баг. Не работает кнопка назад на экране загрузки
    Баг. Поле пи настройке кофа сжато
    Баг. Не могу изменить коф.
    Баг. Много постов где не отобразается "показать"
    Баг. Карточка обновления отвратительно выглядит (Отображать над квестом, но убедиться тчо работате обновление)
    Баг. Вылет сплеша из-за потоков
    Баг. Вылеты чата при загрузке
    Баг. Форматированая ссылка на вики не работает
