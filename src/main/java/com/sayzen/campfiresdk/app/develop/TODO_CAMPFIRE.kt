...
/*
    ...
    Failed to retrieve settings from https://settings.crashlytics.com/spi/v2/platforms/android/apps/com.dzen.campfire/settings
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Оформить статистику карточками
    Возможность сливать фендомы (влить Paint Guide в Painting)

    ачивка за карму на стикерах


    При первом старте приложения настраивать ленту

    Баг. При расширени поста мерцает картинка

    Фэндом. Календарь с событиями

    Возможность закреплять форумы

    Перевести все аниме приложение на мультиязык (+ пытается загрузить рекламу хтя закрыто)
    ...
    Картинки
        -   Экран паков стикеров
        -   Экран стикеров
        -   Экран избранных стикеров
    ...
    Развитие. Система хештегов. Тренды. Поиск по хештегу.
    Развитие. Редактор фото
    Развитие. Возможность в течении короткого времени поменять оценку
    Развитие. Вики (+Лог изменения вики)
    Развитие. Возможность призвать админа/модератора (@Admin @Moderator)
    Развитие. Потдержка (пользовательская (тикеты?))
    Развитие. Баг. У некоторых пользователей время в приложении на час отличается от реального
    Развитие. Оптимизация экранов под планшеты
    Развитие. Вселенные
    Развитие. Система званий
    Развитие. Система коммитетов
    Развитие. Ссылки на фендом по названию (Как быть с языком? Что если в названии есть _)
    Развитие. Секретные ачивки
    Развитие. Холивары
    Развитие. Инвентарь / валюта
    Развитие. Совместное создание статьи
    Развитие. Помечать топовых пользователей
