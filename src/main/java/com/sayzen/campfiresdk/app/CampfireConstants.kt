...
object CampfireConstants {
    ...
    val ACHIEVEMENTS = arrayOf(
            Achievement(API.ACHI_APP_SHARE, R.string.achi_share, R.color.red_500, true, API_RESOURCES.IMAGE_ICHI_3_2),
            Achievement(API.ACHI_CONTENT_SHARE, R.string.achi_content_share, R.color.pink_500, false, API_RESOURCES.IMAGE_ICHI_3_3),
            Achievement(API.ACHI_ADD_RECRUITER, R.string.achi_add_recruiter, R.color.green_500, true, API_RESOURCES.IMAGE_ICHI_1_2),
            Achievement(API.ACHI_ENTERS, R.string.achi_enters, R.color.deep_purple_500, false, API_RESOURCES.IMAGE_ICHI_13),
            Achievement(API.ACHI_KARMA_COUNT, R.string.achi_karma_count, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_20_2),
            Achievement(API.ACHI_REFERRALS_COUNT, R.string.achi_referals_count, R.color.blue_500, false, API_RESOURCES.IMAGE_ICHI_1_3),
            Achievement(API.ACHI_RATES_COUNT, R.string.achi_rates_count, R.color.light_blue_500, false, API_RESOURCES.IMAGE_ICHI_10),
            Achievement(API.ACHI_POSTS_COUNT, R.string.achi_posts_count, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_2_2),
            Achievement(API.ACHI_POST_KARMA, R.string.achi_posts_karma_count, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_5_2),
            Achievement(API.ACHI_COMMENTS_KARMA, R.string.achi_comments_karma_count, R.color.light_green_900, false, API_RESOURCES.IMAGE_ICHI_4_1),
            Achievement(API.ACHI_STICKERS_KARMA, R.string.achi_stickers_karma_count, R.color.lime_900, false, API_RESOURCES.IMAGE_ICHI_4_2),
            Achievement(API.ACHI_COMMENTS_COUNT, R.string.achi_comments_count, R.color.orange_500, false, API_RESOURCES.IMAGE_ICHI_4_4),
            Achievement(API.ACHI_LOGIN, R.string.achi_login, R.color.red_500, true, API_RESOURCES.IMAGE_ICHI_17),
            Achievement(API.ACHI_CHAT, R.string.achi_chat, R.color.blue_500, false, API_RESOURCES.IMAGE_ICHI_3_1),
            Achievement(API.ACHI_COMMENT, R.string.achi_comment, R.color.pink_500, false, API_RESOURCES.IMAGE_ICHI_4_2),
            Achievement(API.ACHI_ANSWER, R.string.achi_answer, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_4_3),
            Achievement(API.ACHI_RATE, R.string.achi_rate, R.color.light_blue_500, false, API_RESOURCES.IMAGE_ICHI_1_5),
            Achievement(API.ACHI_CHANGE_PUBLICATION, R.string.achi_change_publication, R.color.deep_purple_500, false, API_RESOURCES.IMAGE_ICHI_2_3),
            Achievement(API.ACHI_CHANGE_COMMENT, R.string.achi_change_comment, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_4_5),
            Achievement(API.ACHI_REVIEW, R.string.achi_review, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_10),
            Achievement(API.ACHI_FIRST_POST, R.string.achi_first_post, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_2_2),
            Achievement(API.ACHI_SUBSCRIBE, R.string.achi_first_follow, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_5_1),
            Achievement(API.ACHI_TAGS_SEARCH, R.string.achi_tags_search, R.color.pink_500, false, API_RESOURCES.IMAGE_ICHI_9),
            Achievement(API.ACHI_LANGUAGE, R.string.achi_language, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_24),
            Achievement(API.ACHI_TITLE_IMAGE, R.string.achi_title_image, R.color.blue_500, false, API_RESOURCES.IMAGE_ICHI_8, arrayOf(ToolsText.numToStringRound(API.LVL_CAN_CHANGE_PROFILE_IMAGE.lvl / 100.0, 2))),
            Achievement(API.ACHI_CREATE_TAG, R.string.achi_create_tag, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_12),
            Achievement(API.ACHI_QUESTS, R.string.achi_quests, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_6),
            Achievement(API.ACHI_FANDOMS, R.string.achi_fandoms, R.color.orange_500, true, API_RESOURCES.IMAGE_ICHI_19_1),
            Achievement(API.ACHI_RULES_USER, R.string.achi_rules_user, R.color.teal_500, true, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_RULES_MODERATOR, R.string.achi_rules_moderator, R.color.cyan_900, true, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_FOLLOWERS, R.string.achi_followers, R.color.red_500, false, API_RESOURCES.IMAGE_ICHI_5_3),
            Achievement(API.ACHI_MODER_CHANGE_POST_TAGS, R.string.achi_moderators_tags, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_5_3),
            Achievement(API.ACHI_FIREWORKS, R.string.achi_50, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_23),
            Achievement(API.ACHI_MAKE_MODER, R.string.achi_51, R.color.orange_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_CREATE_CHAT, R.string.achi_52, R.color.pink_500, false, API_RESOURCES.IMAGE_ICHI_13),
            Achievement(API.ACHI_REVIEW_MODER_ACTION, R.string.achi_53, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_ACCEPT_FANDOM, R.string.achi_54, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_MODERATOR_COUNT, R.string.achi_55, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_MODERATOR_ACTION_KARMA, R.string.achi_56, R.color.light_blue_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_KARMA_30, R.string.achi_57, R.color.deep_purple_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_UP_RATES, R.string.achi_58, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_UP_RATES_OVER_DOWN, R.string.achi_59, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_CHAT_SUBSCRIBE, R.string.achi_60, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VIDEO_AD, R.string.achi_61, R.color.orange_500, true, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_RELAY_RACE_FIRST_POST, R.string.achi_64, R.color.orange_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_RELAY_RACE_FIRST_NEXT_MEMBER, R.string.achi_65, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_RELAY_RACE_FIRST_CREATE, R.string.achi_66, R.color.teal_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_RELAY_RACE_POSTS_COUNT, R.string.achi_67, R.color.red_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_RELAY_RACE_MY_RACE_POSTS_COUNT, R.string.achi_68, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_ASSIGN, R.string.achi_69, R.color.blue_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_POSTS_COUNT, R.string.achi_70, R.color.indigo_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_WIKI_COUNT, R.string.achi_71, R.color.cyan_900, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_KARMA_COUNT, R.string.achi_72, R.color.red_800, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_SUBSCRIBERS_COUNT, R.string.achi_73, R.color.orange_500, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_LINK, R.string.achi_74, R.color.indigo_800, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_IMAGES, R.string.achi_75, R.color.cyan_700, false, API_RESOURCES.IMAGE_ICHI_21),
            Achievement(API.ACHI_VICEROY_DESCRIPTION, R.string.achi_76, R.color.red_500, false, API_RESOURCES.IMAGE_ICHI_21)
    ...
    fun getAchievement(index: Long): Achievement {
        for (a in ACHIEVEMENTS)
            if (a.info.index == index)
                return a
        return Achievement(API.ACHI_UNKNOWN, R.string.error_unknown, R.color.red_500, true, API_RESOURCES.IMAGE_ICHI_10)
    }
