...
class CardFilters(
    ...
    override fun bindView(view: View) {
        ...
        vFilters.setOnClickListener {
            ...
            WidgetCheckBoxes()
                    .add(R.string.filter_posts).checked(ControllerSettings.fandomFilterModerationsPosts).onChange { w, ww, b -> ControllerSettings.fandomFilterModerationsPosts = b }
                    .add(R.string.filter_only_important).checked(ControllerSettings.fandomFilterOnlyImportant).onChange { w, ww, b -> ControllerSettings.fandomFilterOnlyImportant = b }
                    .add(R.string.filter_events).checked(ControllerSettings.fandomFilterAdministrations).onChange { w, ww, b -> ControllerSettings.fandomFilterAdministrations = b }
                    .add(R.string.filter_moderations).checked(ControllerSettings.fandomFilterModerations).onChange { w, ww, b -> ControllerSettings.fandomFilterModerations = b }
                    .add(R.string.filter_moderations_block).checked(ControllerSettings.fandomFilterModerationsBlocks).onChange { w, ww, b -> ControllerSettings.fandomFilterModerationsBlocks = b }
                    .setOnHide {
