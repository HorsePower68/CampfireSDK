...
class ViewMiniGame @JvmOverloads constructor(
    ...
    private fun setCell(player: Int, index: Int) {
        ...
        cells[index].setImageDrawable(if (player == 1) ToolsResources.getDrawableAttr(R.attr.ic_clear_24dp) else ToolsResources.getDrawableAttr(R.attr.ic_panorama_fish_eye_24dp))
