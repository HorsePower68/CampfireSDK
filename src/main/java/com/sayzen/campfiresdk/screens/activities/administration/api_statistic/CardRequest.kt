...
class CardRequest(
    ...
    override fun bindView(view: View) {
        ...
        vText.text = req.key
        vMiddle.text = ToolsResources.s(R.string.administration_requests_middle) + ":   ${ToolsText.numToStringRound(req.timeMiddle / 1000.0, 2)}  [${ToolsText.numToStringRound(req.timeMin / 1000.0, 2)} - ${ToolsText.numToStringRound(req.timeMax / 1000.0, 2)}]"
        vTotal.text = ToolsResources.s(R.string.administration_requests_count) + ":   ${ToolsText.numToStringRound(req.timeTotal / 1000.0, 2)}   (x${req.count})"
    }
}