    ...
    companion object {
        ...
        fun showConfirmCancelDialog(widget: Widget) {
            ...
            WidgetAlert()
                    ...
                    .setOnEnter(R.string.app_yes) { w -> widget.hide() }
                    .setOnCancel(R.string.app_no)
                    .setOnHide {  w -> widget.setEnabled(true) }
                    .asSheetShow()
        }
