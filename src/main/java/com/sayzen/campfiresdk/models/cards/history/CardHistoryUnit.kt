...
class CardHistoryUnit(
    ...
    override fun bindView(view: View) {
        ...
        when (history) {
            ...
            is HistoryAdminChangeFandom -> vAvatar.setSubtitle(ToolsResources.s(R.string.history_admin_change_fandom, "${history.oldFandomName} ( ${API.LINK_FANDOM.asLink()+ history.oldFandomId})", "${history.newFandomName} (${API.LINK_FANDOM.asLink() + history.newFandomId})"))
            ...
            is HistoryChangeFandom -> vAvatar.setSubtitle(ToolsResources.s(R.string.history_change_fandom, "${history.oldFandomName} ( ${API.LINK_FANDOM.asLink() + history.oldFandomId})", "${history.newFandomName} (${API.LINK_FANDOM.asLink()+ history.newFandomId})"))
