    ...
    override fun bindView(view: View) {
        ...
        vMenu.setOnClickListener {
            WidgetMenu()
                    ...
                    .add(R.string.app_clear_reports) { w, card -> ControllerApi.adminClearReportUnit(unit.id, R.string.post_clear_reports_confirm, R.string.post_error_gone) }.backgroundRes(R.color.blue_700).condition(ControllerApi.can(unit.fandomId, unit.languageId, API.LVL_MODERATOR_BLOCK) && unit.reportsCount > 0)
